...
[
        dcc.Location(id='url'),
        dcc.Link('App', href='/', style=tab_style),
        dcc.Link('Doc', href='/doc', style=tab_style),
    ...
    html.Div([
        html.Div([
            ...
            dcc.Input(
                id='input_url',
                placeholder='https://www.youtube.com/watch?v=sea2K4AuPOk',
                type='text',
                size=85,
                value='',
            ),
    ...
    className='ten columns offset-by-one', style={'display': 'inline-block'}
            ...
            html.Div(
                ...
                # children=[
                        ...
                        #     'textAlign': 'center', }),
                        html.Br(),
                    html.Div(children='Please submit a YouTube video URL on the left and a word you would like to search for in the video on the right.', style={'textAlign': 'center', }),

                    html.Div(children='Wait for the application to finish updating, and it will return a list and histogram of timestamps of your word if it is in the video.', style={'textAlign': 'center', }),
...
def generate_display_tab(tab):
    def display_tab(pathname):
        ...
        # elif tab == 'tab-2':
        #     return {'display': 'block'}
        elif  tab == 'tab-2' and pathname == '/doc':
            return {'display': 'block'}
        else:
            return {'display': 'none'}
    return display_tab
...
def listingtimes(input1,input2):
    try:
        ...
        #if cache_captionsd[input1] == False:
